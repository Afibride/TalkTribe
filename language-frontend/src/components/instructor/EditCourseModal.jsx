...
const EditCourseModal = ({ course, onSuccess, onCancel }) => {
  const [formData, setFormData] = useState({
    ...
    image: null,
    previewImage: course.image_url || null
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post(`/api/courses/${course.id}`, formDataToSend, {
        headers: {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <div className="file-upload">
            ...
            />
            <label htmlFor="edit-course-image" className="file-upload-label">
